...
class ShowFrame extends JFrame{
 ...
 public void actionPerformed(ActionEvent e)     {
     ...
     else if (e.getSource() == b2 && b2.getText().equals("Start"))
     {
         t2.start();
         b2.setText("Stop");
     }
     else   if (e.getSource() == b2 && b2.getText().equals("Stop"))
     {
        ...
        {
            t1.setDelay( Integer.parseInt(combo.getSelectedItem().toString()));
            t2.setDelay( Integer.parseInt(combo.getSelectedItem().toString()));
        }
    ...
    MyPanel()   {  
      ...
      this.add(b1);
       ...
       combo.addItem("1");combo.addItem("100");combo.addItem("500");combo.addItem("1000");combo.addItem("5000");
